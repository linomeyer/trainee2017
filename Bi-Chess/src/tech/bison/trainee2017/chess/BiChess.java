...
public class BiChess {
  ...
  // break;
  // default:
  // repeat = !yesNoInput("Beenden?", "Wollen Sie das Programm wirklich
  // beenden?");
  // break;
  // }
  //
  ...
  // }
  //
  // private static void farmer() throws StoppedByUserException,
  // InvalidPositionException {
  // int collorOfFarmer = options("Farbe wählen", "Welche Farbe hat der Bauer?",
  // new String[] { "Weiss", "Schwarz" });
  ...
  // int x = 1 + options(positionName, "Geben Sie die " + positionName + " ein
  // [z.B. C4]:",
  // new String[] { "A", "B", "C", "D", "E", "F", "G", "H" });
  // int y;
  // try {
  // y = 1 + options(positionName, "Geben Sie die " + positionName + " ein [z.B.
  ...
  // if (validMove) {
  // JOptionPane.showMessageDialog(null, "Der Zug mit der Figur " + figureName + "
  // vom Feld " + start.getPosition()
  ...
  // int input = JOptionPane.showOptionDialog(null, Message, screenTitle, 1, 3,
  // null, new String[] { "Ja", "Nein" },
  // null);
  // return input == 0;
  // }
  //
  // private static int options(String title, String message, String[] options) {
  // return JOptionPane.showOptionDialog(null, message, title, 0, 3, null,
  // options, options);
  // }
}
